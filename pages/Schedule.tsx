    ...
    <div className="bg-gray-50 min-h-screen pt-24 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="p-0">
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b border-gray-100">
                      <tr>
                        <th className="px-8 py-5 text-left text-xs font-bold text-gray-500 uppercase tracking-widest">
                          Route
                        </th>
                        <th className="px-8 py-5 text-right text-xs font-bold text-gray-500 uppercase tracking-widest">
                          Time
                        </th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      <tr className="hover:bg-teal-50/30 transition-colors group">
                        <td className="px-8 py-6 font-medium text-navy text-lg">
                          Tok Bali{" "}
                          <span className="text-gray-300 mx-3 group-hover:text-brand-teal transition-colors">
                            →
                          </span>{" "}
                          Perhentian
                        </td>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-10 border border-gray-100">
                ...
                <ul className="space-y-4 text-gray-600 text-base leading-relaxed">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-brand-orange rounded-full mt-2.5 mr-4 flex-shrink-0"></span>
                    Luggage allowance is 20kg per person. Extra charges may
                    apply for oversized items.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div
            className={
              activeTab === "Perhentian" ? "lg:col-span-1" : "lg:col-span-3"
            }
          >
            <div className="bg-brand-teal rounded-2xl shadow-2xl p-8 text-white relative overflow-hidden h-full">
              ...
              {activeTab === "Perhentian" ? (
                <>
                  <h3 className="text-3xl font-serif font-bold mb-2 relative z-10">
                    Ticket Fares
                  </h3>
                  <p className="text-teal-100 text-sm mb-10 relative z-10 font-medium tracking-wide">
                    Return Trip (Two-way)
                  </p>

                  <div className="space-y-4 relative z-10">
                    <div className="bg-white/10 p-5 rounded-2xl border border-white/20 backdrop-blur-sm">
                      <p className="text-xs uppercase tracking-widest font-bold text-teal-100 mb-2">
                        Dewasa (Pergi & Balik)
                      </p>
                      <div className="flex items-baseline">
                        <span className="text-lg font-medium">RM</span>
                        <span className="text-5xl font-bold ml-2 font-serif">
                          80
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-12 pt-8 border-t border-white/20 relative z-10">
                    <Link to="/contact">
                      <Button
                        variant="primary"
                        fullWidth
                        className="bg-brand-orange text-white hover:bg-white hover:text-brand-orange border-none py-4 text-sm shadow-xl"
                      >
                        Book Tickets Now
                      </Button>
                    </Link>
