...
import { MessageCircle, MapPin, Phone, Mail, Clock, Send, ChevronDown } from 'lucide-react';
...
const contactSchema = z.object({
  ...
  passengers: z.number().min(1, { message: "At least 1 passenger required" }).max(28),
...
const Contact: React.FC = () => {
  ...
  const inputClass = "w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-brand-teal focus:ring-4 focus:ring-brand-teal/10 outline-none transition-all duration-300 text-navy placeholder:text-gray-400 font-medium text-sm";
  const labelClass = "text-xs font-bold text-navy uppercase tracking-widest ml-1 mb-1.5 block";
    ...
    <div className="pt-24 min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-navy text-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <span className="text-brand-orange font-bold uppercase tracking-[0.25em] text-xs mb-4 block animate-fade-in">Get in Touch</span>
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6 tracking-tight leading-tight">{t('contact.title')}</h1>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed">{t('contact.subtitle')}</p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-2xl p-8 md:p-12 border border-gray-100/50">
            <div className="flex items-center mb-10 border-b border-gray-100 pb-6">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Fill out the form below and we will get back to you shortly.</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1">
                  ...
                  <input 
                    ...
                    className={inputClass}
                  />
                  {errors.passengers && <p className="text-red-500 text-xs mt-1.5 ml-1 font-medium">{errors.passengers.message}</p>}
                </div>
                 ...
                 <div className="md:col-span-2">
                  ...
                  <input 
                    ...
                    className={inputClass}
                  />
                  {errors.date && <p className="text-red-500 text-xs mt-1.5 ml-1 font-medium">{errors.date.message}</p>}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Perhentian">Pulau Perhentian (Perhentian Island)</option>
                ...
                {errors.destination && <p className="text-red-500 text-xs mt-1.5 ml-1 font-medium">{errors.destination.message}</p>}
              </div>
          ...
          <div className="space-y-6 lg:mt-8">
            <div className="bg-gradient-to-br from-brand-teal to-brand-dark rounded-2xl shadow-xl p-8 text-white relative overflow-hidden group">
              ...
              <p className="text-teal-50 mb-8 text-sm leading-relaxed relative z-10">
                Prefer to chat directly? Click below to open WhatsApp with our support team immediately. We typically reply within 15 minutes.
              </p>
              <a 
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              <h3 className="text-xl font-bold text-navy mb-6 font-serif border-b border-gray-100 pb-4 tracking-tight">Office Info</h3>
              ...
              <div className="space-y-8">
                <div className="flex items-start group">
                  ...
                  <div>
                    <h4 className="font-bold text-navy text-xs uppercase tracking-widest mb-1.5">Address</h4>
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Jalan Tok Bali - Kuala Besut,<br/>
                      Semerak, 16700 Pasir Puteh,<br/>
                      Kelantan
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <h4 className="font-bold text-navy text-xs uppercase tracking-widest mb-1.5">Operating Hours</h4>
                    <p className="text-gray-600 text-sm">
                      <span className="font-semibold text-navy">Boat Services:</span><br/>8:00 AM - 3:00 PM
                    </p>
                    <p className="text-gray-600 text-sm mt-2">
                      <span className="font-semibold text-navy">Jetty Terminal:</span><br/>8:00 AM - 10:00 PM
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start group">
                  ...
                  <div>
                    <h4 className="font-bold text-navy text-xs uppercase tracking-widest mb-1.5">Phone Support</h4>
                    <p className="text-brand-orange font-bold text-lg tracking-tight">+60 12-345 6789</p>
                    <p className="text-xs text-gray-400 mt-0.5">Available 8am - 10pm</p>
                  </div>
                </div>
              </div>
            </div>
